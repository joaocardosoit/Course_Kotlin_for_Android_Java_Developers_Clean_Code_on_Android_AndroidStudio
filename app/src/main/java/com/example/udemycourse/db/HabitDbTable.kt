package com.example.udemycourse.db
...
import com.example.udemycourse.Habit
import com.example.udemycourse.db.HabitEntry.DESCR_COL
import com.example.udemycourse.db.HabitEntry.IMAGE_COL
import com.example.udemycourse.db.HabitEntry.TABLE_NAME
import com.example.udemycourse.db.HabitEntry.TITLE_COL
import com.example.udemycourse.db.HabitEntry._ID
...
private inline fun <T> SQLiteDatabase.transacti(function: SQLiteDatabase.() -> T): T{
    beginTransaction()
    val result = try {
